...
# Use the default VPC to keep the Day 17 dev test harness lightweight and easy to rerun.
...
# Treat dev like a real root module that consumes the reusable Day 17 service module.
