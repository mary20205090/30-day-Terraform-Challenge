variable "cluster_name" {
  description = "Base name used to build the webserver cluster resources"
  type        = string
}
...
variable "server_port" {
  description = "Port served by the webserver application"
  type        = number
  default     = 8080
}

variable "server_text" {
  description = "Text returned by the webserver app"
  type        = string
  default     = "Hello World"
}
